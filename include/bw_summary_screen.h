...
// configs
#define BW_SUMMARY_AUTO_FORMAT_MOVE_DESCRIPTIONS    FALSE               // automatically formats move descriptions to fit the new box size. disable if you want to format them manually
