...
enum {
    ...
    // Kanto
    NATIONAL_DEX_KIWEE,
    NATIONAL_DEX_FRONDODO,
    NATIONAL_DEX_OSTRIPALM,
    NATIONAL_DEX_KINDLANT,
    NATIONAL_DEX_CALIANTE,
    NATIONAL_DEX_SCORNET,
    NATIONAL_DEX_PINNIPET,
    NATIONAL_DEX_WALRINCE,
    NATIONAL_DEX_SELKING,
    NATIONAL_DEX_LOVERET,
    NATIONAL_DEX_CUPIN,
    NATIONAL_DEX_LINTSECT,
    NATIONAL_DEX_DROSODUST,
    NATIONAL_DEX_ORBUNCLE,
    NATIONAL_DEX_MAGTAIL,
    NATIONAL_DEX_MURMURAVEN,
    NATIONAL_DEX_NEVERMORN,
    NATIONAL_DEX_HOPSTALK,
    NATIONAL_DEX_RUTABUNNY,
    NATIONAL_DEX_LYNDWURM,
    NATIONAL_DEX_EARTHWYRM,
    NATIONAL_DEX_MINIERAL,
    NATIONAL_DEX_DIABUNCLE,
    NATIONAL_DEX_INGLET,
    NATIONAL_DEX_HOGWELD,
    NATIONAL_DEX_HOGGERNAUT,
    NATIONAL_DEX_CUMULAMB,
    NATIONAL_DEX_NIMBAA,
    NATIONAL_DEX_RAMSTROM,
    NATIONAL_DEX_PUKOO,
    NATIONAL_DEX_RANKOO,
    NATIONAL_DEX_BONNIFIRE,
    NATIONAL_DEX_BUDEW,
    ...
    NATIONAL_DEX_SCARLASS,
    NATIONAL_DEX_RAIDINHOOD,
    NATIONAL_DEX_FILAMIN,
    NATIONAL_DEX_FILAMAX,
    NATIONAL_DEX_INCANDELUX,
    NATIONAL_DEX_NEADOUGH,
    NATIONAL_DEX_MOLDOUGH,
    NATIONAL_DEX_MAREEP,
