...
#define OBJ_EVENT_GFX_UNUSED_KELPONI_DOLL        78
...
#define OBJ_EVENT_GFX_BIG_TROPIKOEKA_DOLL          180
#define OBJ_EVENT_GFX_BIG_SCORNET_DOLL         181
#define OBJ_EVENT_GFX_BIG_AQUASTRIAN_DOLL         182
