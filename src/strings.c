...
const u8 gText_12PoofForgotMove[] = _("{PLAY_SE SE_BALL_BOUNCE_1}{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TropikoekaDoll256BP[] = _("TROPIKOEKA DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_ScornetDoll256BP[] = _("SCORNET DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_AquastrianDoll256BP[] = _("AQUASTRIAN DOLL{CLEAR_TO 0x58}256BP");
