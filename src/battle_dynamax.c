...
{
    {SPECIES_TROPIKOEKA_GIGANTAMAX,                   TYPE_GRASS,      MOVE_G_MAX_VINE_LASH},
    {SPECIES_AQUASTRIAN_GIGANTAMAX,                  TYPE_WATER,      MOVE_G_MAX_CANNONADE},
    {SPECIES_SCORNET_GIGANTAMAX,                  TYPE_FIRE,       MOVE_G_MAX_WILDFIRE},
    {SPECIES_LINTSECT_GIGANTAMAX,                 TYPE_BUG,        MOVE_G_MAX_BEFUDDLE},
