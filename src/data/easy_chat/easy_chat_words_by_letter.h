...
const u16 gEasyChatWordsByLetter_A[] = {
    ...
    EC_WORD_APPRECIATE,
    EC_WORD_APPROVED,
    EC_POKEMON_NATIONAL(HOGGERNAUT),
...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_MOVE(BITE),
    EC_MOVE2(BLAST_BURN),
    EC_POKEMON_NATIONAL(AQUASTRIAN),
    EC_WORD_BLAZE,
    EC_MOVE2(BLAZE_KICK),
    EC_POKEMON(BLAZIKEN),
    EC_WORD_BLEND,
    ...
    EC_WORD_BUG,
    EC_POKEMON_NATIONAL(KIWEE),
    EC_MOVE2(BULK_UP),
    EC_MOVE2(BULLET_SEED),
    EC_WORD_BUSY,
    EC_WORD_BUT,
    EC_POKEMON_NATIONAL(LINTSECT),
    EC_WORD_BYE_BYE,
};
...
const u16 gEasyChatWordsByLetter_C[] = {
    ...
    EC_MOVE(CHARGE),
    EC_POKEMON_NATIONAL(SCORNET),
    EC_MOVE(CHARM),
    EC_POKEMON_NATIONAL(KINDLANT),
    EC_POKEMON_NATIONAL(CALIANTE),
    EC_WORD_CHAT,
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    EC_POKEMON_NATIONAL(NEVERMORN),
    EC_POKEMON_NATIONAL(MURMURAVEN),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(PIKACHU),
...
const u16 gEasyChatWordsByLetter_V[] = {
    ...
    EC_POKEMON_NATIONAL(TROPIKOEKA),
    EC_WORD_VERSION,
    EC_WORD_VERSUS,
    EC_WORD_VERY,
    EC_POKEMON(VIBRAVA),
