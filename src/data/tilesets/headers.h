...
const struct Tileset gTileset_PrimaryGrass =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PrimaryGrass,
    .palettes = gTilesetPalettes_PrimaryGrass,
    .metatiles = gMetatiles_PrimaryGrass,
    .metatileAttributes = gMetatileAttributes_PrimaryGrass,
    .callback = NULL,
};

const struct Tileset gTileset_Hometown =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Hometown,
    .palettes = gTilesetPalettes_Hometown,
    .metatiles = gMetatiles_Hometown,
...
const struct Tileset gTileset_GardenCity =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_GardenCity,
    .palettes = gTilesetPalettes_GardenCity,
    .metatiles = gMetatiles_GardenCity,
    .metatileAttributes = gMetatileAttributes_GardenCity,
    .callback = NULL,
};
