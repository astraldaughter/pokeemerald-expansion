const u32 *const gDecorIconTable[][2] =
{
    ...
    [DECOR_TROPIKOEKA_DOLL]   = {gDecorIcon_TropikoekaDoll, gDecorIconPalette_TropikoekaDoll},
    [DECOR_SCORNET_DOLL]  = {gDecorIcon_ScornetDoll, gDecorIconPalette_ScornetDoll},
    [DECOR_AQUASTRIAN_DOLL]  = {gDecorIcon_AquastrianDoll, gDecorIconPalette_AquastrianDoll},
