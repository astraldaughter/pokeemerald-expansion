...
const struct BattleMoveEffect gBattleMoveEffects[NUM_BATTLE_MOVE_EFFECTS] =
{
    ...
    [EFFECT_PANIC] =
    {
        .battleScript = BattleScript_EffectPanic,
        .battleTvScore = 4,
        .encourageEncore = TRUE,
    },
    ...
    [EFFECT_KINDLING] =
    {
        .battleScript = BattleScript_EffectKindling,
        .battleTvScore = 0, // TODO: Assign points
        .encourageEncore = TRUE,
    },
    ...
    [EFFECT_BULLET_SEED] =
    {
        .battleScript = BattleScript_EffectBulletSeed,
        .battleTvScore = 1,
    },
