...
static const u8 sText_HeatingUpBeak[] = _("{B_ATK_NAME_WITH_PREFIX} is\nheating up!");
...
static const u8 sText_TuberousHpUp[] = _("{B_ATK_NAME_WITH_PREFIX} absorbed nutrients\nfrom the soil!");

const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    [STRINGID_TUBEROUSHPUP - BATTLESTRINGS_TABLE_START] = sText_TuberousHpUp,
