...
static const u8 sText_Trainer1WantsToBattle[] = _("{B_TRAINER1_NAME_WITH_CLASS} would like to battle!\p");
static const u8 sText_LinkTrainerWantsToBattle[] = _("{B_LINK_OPPONENT1_NAME} would like to battle!");
static const u8 sText_TwoLinkTrainersWantToBattle[] = _("{B_LINK_OPPONENT1_NAME} and {B_LINK_OPPONENT2_NAME} would like to battle!!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{PAUSE 32}Give up on learning {B_BUFF2}?"),
    ...
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("Hit {B_BUFF1} time(s)!"), //SV has dynamic plural here
    ...
    [STRINGID_PKMNHURTBYPOISON]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by poison!"),
    ...
    [STRINGID_PKMNHURTBYBURN]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by its burn!"),
    ...
    [STRINGID_PKMNWASPARALYZEDBY]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} paralyzed {B_EFF_NAME_WITH_PREFIX2}! It may be unable to move!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNFLINCHED]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} flinched!"),
    [STRINGID_PKMNREGAINEDHEALTH]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} regained health!"),
    [STRINGID_PKMNHPFULL]                           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s HP is full!"),
    [STRINGID_PKMNRAISEDSPDEF]                      = COMPOUND_STRING("LIGHTSCREEN made {B_ATK_TEAM2} team stronger against special moves!"),
    ...
    [STRINGID_PKMNDUGHOLE]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} burrowed underground!"),
    ...
    [STRINGID_PKMNUPROARKEPTAWAKE]                  = COMPOUND_STRING("The UPROAR kept {B_SCR_NAME_WITH_PREFIX2} awake!"),
    ...
    [STRINGID_PKMNENCOREENDED]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ENCORE ended!"),
    ...
    [STRINGID_PKMNTRYINGTOTAKEFOE]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is trying to take its foe down with it!"),
    [STRINGID_PKMNTOOKFOE]                          = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} took its foe down with it!"),
    ...
    [STRINGID_TARGETCANTESCAPENOW]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} can't escape anymore!"),
    ...
    [STRINGID_PKMNHASNOMOVESLEFT]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} has no moves left!\p"),
    ...
    [STRINGID_TOOWEAKFORSUBSTITUTE]                 = COMPOUND_STRING("But it doesn't have enough HP left to make a SUBSTITUTE!"),
    ...
    [STRINGID_PKMNSITEMDEFROSTEDIT]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} thawed it out!"),
    ...
    [STRINGID_ELECTRICITYWEAKENED]                  = COMPOUND_STRING("ELECTRIC power was weakened!"),
    [STRINGID_FIREWEAKENED]                         = COMPOUND_STRING("FIRE power was weakened!"),
    ...
    [STRINGID_POISONSPIKESSCATTERED]                = COMPOUND_STRING("TOXIC SPIKES were scattered on the ground all around {B_DEF_TEAM2} team!"),
    ...
    [STRINGID_PKMNBLEWAWAYTOXICSPIKES]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blew away TOXIC!"),
...
const u16 gMoveWeatherChangeStringIds[] =
{
    ...
    [B_MSG_STARTED_THUNDERSTORM]       = STRINGID_THUNDERSTORMBREWED,
};
...
const u16 gWeatherEndsStringIds[B_MSG_WEATHER_END_COUNT] =
{
    ...
    [B_MSG_WEATHER_END_THUNDERSTORM] = STRINGID_THUNDERSTORMSTOPPED,
};
...
const u16 gSandStormHailDmgStringIds[] =
{
    ...
    [B_MSG_THUNDERSTORM] = STRINGID_PKMNSTRUCKBYLIGHTNING
};
