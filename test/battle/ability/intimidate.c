...
SINGLE_BATTLE_TEST("Intimidate (opponent) lowers player's attack after switch out", s16 damage)
{
    ...
    GIVEN {
        ...
        if (ability == ABILITY_INTIMIDATE)
        {
            ...
            MESSAGE("Foe Hoggernaut's Intimidate cuts Wobbuffet's attack!");
        }
...
SINGLE_BATTLE_TEST("Intimidate (opponent) lowers player's attack after KO", s16 damage)
{
    ...
    GIVEN {
        ...
        OPPONENT(SPECIES_HOGGERNAUT) { Ability(ability); Speed(1); }
    } WHEN {
...
DOUBLE_BATTLE_TEST("Intimidate doesn't activate on an empty field in a double battle")
{
    GIVEN {
        ...
        NONE_OF {
            ...
            MESSAGE("Hogweld's Intimidate cuts Foe Hoggernaut's attack!");
            ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_STATS_CHANGE, opponentRight);
            MESSAGE("Hogweld's Intimidate cuts Foe Wynaut's attack!");

            ABILITY_POPUP(opponentLeft, ABILITY_INTIMIDATE);
            ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_STATS_CHANGE, playerLeft);
            MESSAGE("Foe Hoggernaut's Intimidate cuts Hogweld's attack!");
            ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_STATS_CHANGE, playerRight);
            MESSAGE("Foe Hoggernaut's Intimidate cuts Abra's attack!");
        }
    }
}
