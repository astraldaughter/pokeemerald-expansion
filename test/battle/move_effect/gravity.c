...
DOUBLE_BATTLE_TEST("Gravity cancels fly and sky drop if they are in the air")
{
    ...
    GIVEN {
        ...
        OPPONENT(SPECIES_MURMURAVEN) { Speed(50); }
        ...
        // turn 1
        MESSAGE("The opposing Murmuraven used Sky Drop!");
        MESSAGE("The opposing Murmuraven took Wynaut into the sky!");
        ...
        MESSAGE("The opposing Murmuraven fell from the sky due to the gravity!");
        MESSAGE("The opposing Rookidee fell from the sky due to the gravity!");
        MESSAGE("The opposing Murmuraven can't use Sky Drop because of gravity!");
